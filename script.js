...
//Birth Date
let birthDateInput = document.getElementById("date");
let birthDateError = document.getElementById("birth-date-error");
let emptyBirthDateError = document.getElementById("empty-birth-date");
